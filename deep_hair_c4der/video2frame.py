...
def extract_frames(video_path, frames_dir, overwrite=False, start=-1, end=-1, every_sec=20):
    """
    ...
    :param end: end frame
    :param every: frame spacing (in seconds)
...
if __name__ == '__main__':
    # test it
    start = time.time()
    video_to_frames(video_path='./videos/test.mp4', frames_dir='./frames', overwrite=True, every=20, chunk_size=1000)
